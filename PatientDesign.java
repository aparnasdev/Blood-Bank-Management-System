...
public class PatientDesign extends JFrame implements ActionListener{
	...
	PatientDesign(){
		...
		JLabel label = new JLabel("Patient Details Management");
		...
		desc = new JLabel("Patient Id: ");
		n = new JTextField("P001", 5);
		addBtn = new JButton("Add new Patient");
		editBtn = new JButton("Edit details of patient");
