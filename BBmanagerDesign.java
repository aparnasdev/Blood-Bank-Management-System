...
public class BBmanagerDesign extends JFrame implements ActionListener{
	...
	BBmanagerDesign(){
		...
		JLabel label = new JLabel("Manager Details Management");
		...
		desc = new JLabel("Manager Id: ");
		n = new JTextField("M001", 5);
		addBtn = new JButton("Add new Manager");
		editBtn = new JButton("Edit details of manager");
		searchBtn = new JButton("Search");
		deleteBtn = new JButton("Delete manager");
