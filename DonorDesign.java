...
public class DonorDesign extends JFrame implements ActionListener{
	...
	DonorDesign(){
		...
		JLabel label = new JLabel("Donor Details Management");
		...
		desc = new JLabel("Donor Id: ");
		n = new JTextField("A001", 5);
		addBtn = new JButton("Add new Donor");
		editBtn = new JButton("Edit details of donor");
